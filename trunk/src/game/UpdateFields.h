...
enum EUnitFields
{
	...
	UNIT_FIELD_XP             = OBJECT_END + 0x003B, // Size: 4 INT PUBLIC
	UNIT_FIELD_NEXT_LEVEL_XP  = OBJECT_END + 0x003F, // Size: 4 INT PUBLIC

	UNIT_FIELD_FLAGS          = OBJECT_END + 0x0043, // Size: 1 INT PUBLIC
	UNIT_DYNAMIC_FLAGS        = OBJECT_END + 0x0044, // Size: 1 INT OWNER_ONLY
	UNIT_NPC_FLAGS            = OBJECT_END + 0x0045, // Size: 1 INT DYNAMIC
	UNIT_FIELD_DISPLAYID      = OBJECT_END + 0x0046, // Size: 2 INT PUBLIC

	UNIT_FIELD_SPELL_POINT    = OBJECT_END + 0x0048, // Size: 2 INT PUBLIC
	UNIT_FIELD_STAT_POINT     = OBJECT_END + 0x004A, // Size: 2 INT PUBLIC

	UNIT_END                  = OBJECT_END + 0x004C, // Size: 1 INT PUBLIC
