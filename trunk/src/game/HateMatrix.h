/* 
 * Copyright (C) 2005-2008 LeGACY <http://code.google.com/p/legacy-project/>
 *
...
#ifndef __LEGACY_HATEMATRIX_H
#define __LEGACY_HATEMATRIX_H
...
struct LEGACY_DLL_DECL HateMatrix
{
