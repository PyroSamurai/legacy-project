...
#ifndef __LEGACY_GRIDDEFINES_H
#define __LEGACY_GRIDDEFINES_H
...
struct LEGACY_DLL_DECL CoordPair
{
...
namespace LeGACY
{
	...
	{
		// calculate and store temporary values in double format for having some result as same mySQL calculations
	...
	inline bool IsValieMapCoord(float x, float y)
	{
