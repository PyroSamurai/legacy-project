...
ChatCommand * ChatHandler::getCommandTable()
{
	...
	static ChatCommand commandTable[] =
	{
		...
		{ "lookup", SEC_GAMEMASTER, NULL, "", lookupCommandTable },
		{ "npc", SEC_GAMEMASTER, NULL, "", npcCommandTable },
		{ "item", SEC_GAMEMASTER, NULL, "", itemCommandTable },
		...
		{ "changelevelpet", SEC_GAMEMASTER, &ChatHandler::HandleChangeLevelPetCommand, "", NULL },
		{ "save", SEC_PLAYER, &ChatHandler::HandleSaveCommand, "", NULL },
		{ "rest", SEC_PLAYER, &ChatHandler::HandleRestCommand, "", NULL },
