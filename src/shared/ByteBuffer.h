...
#ifndef __LEGACY_BYTEBUFFER_H
#define __LEGACY_BYTEBUFFER_H
...
class ByteBuffer
{
    public:
        ...
        {
            append<uint8>ENCODE(value);
            return *this;
        }
        ByteBuffer &operator<<(uint16 value)
        {
            append<uint16>ENCODE(value);
            return *this;
        }
        ByteBuffer &operator<<(uint32 value)
        {
            append<uint32>ENCODE(value);
            return *this;
        }
        ByteBuffer &operator<<(uint64 value)
        {
            append<uint64>ENCODE(value);
            return *this;
        }
        ...
        ByteBuffer &operator<<(const std::string &value)
        {
			...
			append((uint8 const *)(ENCODE(value)).c_str(), value.length());
            //append((uint8)0);
            return *this;
        }
        ByteBuffer &operator<<(const char *str)
        {
            append((uint8 const *)ENCODE(str), str ? strlen(str) : 0);
            //append((uint8)0);
            return *this;
        }
        ...
        ByteBuffer &operator>>(uint8 &value)
        {
            value = ENCODE(read<uint8>());
            return *this;
        }
        ByteBuffer &operator>>(uint16 &value)
        {
            value = ENCODE(read<uint16>());
            return *this;
        }
        ByteBuffer &operator>>(uint32 &value)
        {
            value = ENCODE(read<uint32>());
            return *this;
        }
        ByteBuffer &operator>>(uint64 &value)
        {
            value = ENCODE(read<uint64>());
            return *this;
        }
        ...
        void hexlike()
        {
            ...
            for(uint32 i = 0; i < size(); i++)
            {
                if ((i == (j*8)) && ((i != (k*16))))
                {
                    ...
                    {
                        sLog.outDebugInLine("| %.2X ", (read<uint8>(i) ^ 0xAD) );
                    }
                    else
                    {
                        sLog.outDebugInLine("| %.2X ", (read<uint8>(i) ^ 0xAD) );
