...
#ifndef __LEGACY_SQLOPERATIONS_H
#define __LEGACY_SQLOPERATIONS_H
...
class SqlQueryHolder;          /// groups several async queries
class SqlQueryHolderEx;        /// points to a holder added to the delay thread

class SqlResultQueue : public ZThread::LockedQueue<LeGACY::IQueryCallback*, ZThread::FastMutex>
{
	public:
		SqlResultQueue() {}
		void Update();
...
class SqlQuery : public SqlOperation
{
	private:
		const char *m_sql;
		LeGACY::IQueryCallback * m_callback;
		SqlResultQueue * m_queue;
	public:
		SqlQuery(const char *sql, LeGACY::IQueryCallback * callback, SqlResultQueue * queue)
...
class SqlQueryHolder
{
	...
	public:
		...
		void Execute(LeGACY::IQueryCallback * callback, SqlDelayThread *thread, SqlResultQueue *queue);
};
...
class SqlQueryHolderEx : public SqlOperation
{
	private:
		...
		SqlResultQueue * m_queue;
	public:
		SqlQueryHolderEx(SqlQueryHolder *holder, LeGACY::IQueryCallback * callback, SqlResultQueue * queue)
