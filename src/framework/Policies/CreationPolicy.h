...
#ifndef __LEGACY_CREATIONPOLICY_H
#define __LEGACY_CREATIONPOLICY_H
...
namespace LeGACY
{
	 ...
	 */
	template <class T>
		class LEGACY_DLL_DECL OperatorNew
	{
		public:
	 ...
	 */
	template <class T>
		class LEGACY_DLL_DECL LocalStaticCreation
	{
		union MaxAlign
		{
			char t_[sizeof(T)];
	...
	/**
	 * CreateUsingMalloc by pass the memory manager.
	 */
	template<class T>
		class LEGACY_DLL_DECL CreateUsingMalloc
	{
		public:
			static T* Create()
			{
	...
	template<class T, class CALL_BACK>
		class LEGACY_DLL_DECL CreateOnCallBack
	{
		public:
			static T* Create()
			{
